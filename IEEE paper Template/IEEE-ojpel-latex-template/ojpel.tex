...
\AtBeginDocument{\definecolor{ojcolor}{cmyk}{0,1,0.63,0.12}}
\def\OJlogo{\vspace{-10pt}\includegraphics[height=22pt]{ojpel-logo.png}}
\begin{document}
...
\begin{IEEEkeywords}
Enter key words or phrases in alphabetical order, separated by commas. Autocorrelation,
...
template of your preferred publication from the IEEE Web site at \underline
{https://template-selector.ieee.org/secure/templateSelector}\break\underline{/publicationType} so you can use it to prepare your manuscript.
...
\subsection{CHECKING YOUR FIGURES}
IEEE accepts a wide variety of graphics files for publication. When you submit your article, your graphics will be automatically checked by IEEE.
To follow our guidelines on how to create quality graphics, please consult the IEEE Author Center at \underline{https://ieeeauthorcenter.ieee.org/}  
for help on creating high-quality graphics.
...
system, ScholarOne{\textregistered} Manuscripts. For more information, please visit \underline{http://www.ieee.org/publications\_standards/publications/}\break
\underline{authors/authors\_submission.html}.
 First 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author3.png}}]{THIRD
